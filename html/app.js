...
const app = Vue.createApp({
  data: function() {
      ...
      hudAlignment: this.initHudAlignment(),
		};
	},
  setup () {
    const progress = ref([
  ...
  watch: {
   ...
   hudAlignment: function() {
      localStorage.setItem("hudAlignment", this.hudAlignment);
    },
  ...
  methods: {
    ...
    initIsCinematicNotifChecked: function() {
      ...
      initHudAlignment: function() {
      const stored = localStorage.getItem("hudAlignment");
			if (stored === null) {
				return "center";
			} else {
				return stored;
    ...
    changeHudAlignment: function(alignment) {
      changeHudAlignment(alignment)
    },
...
function closeMenu() {
  ...
  $.post('https://mfw-hud/closeMenu');
}
function restartHud() {
  closeMenu()
  $.post('https://mfw-hud/restartHud');
}
function resetStorage() {
  closeMenu()
  $.post('https://mfw-hud/resetStorage');
}
function showOutMap() {
  $.post('https://mfw-hud/showOutMap');
}
function showOutCompass() {
  $.post('https://mfw-hud/showOutCompass');
}
function showFollowCompass() {
  $.post('https://mfw-hud/showFollowCompass');
}
function openMenuSounds() {
  $.post('https://mfw-hud/openMenuSounds');
}
function resetHudSounds() {
  $.post('https://mfw-hud/resetHudSounds');
}
function checklistSounds() {
  $.post('https://mfw-hud/checklistSounds');
}
function showMapNotif() {
  $.post('https://mfw-hud/showMapNotif');
}
function showFuelAlert() {
  $.post('https://mfw-hud/showFuelAlert');
}
function showCinematicNotif() {
  $.post('https://mfw-hud/showCinematicNotif');
}
function dynamicHealth() {
  $.post('https://mfw-hud/dynamicHealth');
}
function dynamicArmor() {
  $.post('https://mfw-hud/dynamicArmor');
}
function dynamicHunger() {
  $.post('https://mfw-hud/dynamicHunger');
}
function dynamicThirst() {
  $.post('https://mfw-hud/dynamicThirst');
}
function dynamicStress() {
  $.post('https://mfw-hud/dynamicStress');
}
function dynamicOxygen() {
  $.post('https://mfw-hud/dynamicOxygen');
}
function dynamicEngine() {
  $.post('https://mfw-hud/dynamicEngine');
}
function dynamicNitro() {
  $.post('https://mfw-hud/dynamicNitro');
}
function ToggleMapShape() {
  $.post('https://mfw-hud/ToggleMapShape');
}
function changeFPS() {
  $.post('https://mfw-hud/changeFPS');
}
function ToggleMapBorders() {
  $.post('https://mfw-hud/ToggleMapBorders');
}
function HideMap() {
  $.post('https://mfw-hud/HideMap');
}
function changeCompassFPS() {
  $.post('https://mfw-hud/changeCompassFPS');
}
function showCompassBase() {
  $.post('https://mfw-hud/showCompassBase');
}
function showStreetsNames() {
  $.post('https://mfw-hud/showStreetsNames');
}
function showPointerIndex() {
  $.post('https://mfw-hud/showPointerIndex');
}
function showDegreesNum() {
  $.post('https://mfw-hud/showDegreesNum');
}
function changeHudAlignment(alignment) {
  $.post('https://mfw-hud/changeHudAlignment', JSON.stringify({ alignment: alignment }));
}
function cinematicMode() {
  $.post('https://mfw-hud/cinematicMode');
}
...
const playerHud = {
  ...
  methods: {
    hudTick(data) {
      this.hudAlignment = data.hudAlignment;
      this.show = data.show;
      ...
      if (data.hudAlignment == "flex-end") {
        this.hudMarginRight = "10vh";
      } else {
        this.hudMarginRight = "0";
      }
